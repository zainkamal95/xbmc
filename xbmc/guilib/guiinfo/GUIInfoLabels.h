...
#define PLAYER_PROCESS_VIDEO_DOVI_VERSION_MAJOR (PLAYER_PROCESS + 30)
#define PLAYER_PROCESS_VIDEO_DOVI_VERSION_MINOR (PLAYER_PROCESS + 31)
#define PLAYER_PROCESS_VIDEO_DOVI_PROFILE (PLAYER_PROCESS + 32)
#define PLAYER_PROCESS_VIDEO_DOVI_LEVEL (PLAYER_PROCESS + 33)
#define PLAYER_PROCESS_VIDEO_DOVI_RPU_PRESENT (PLAYER_PROCESS + 34)
#define PLAYER_PROCESS_VIDEO_DOVI_EL_PRESENT (PLAYER_PROCESS + 35)
#define PLAYER_PROCESS_VIDEO_DOVI_BL_PRESENT (PLAYER_PROCESS + 36)
#define PLAYER_PROCESS_VIDEO_DOVI_BL_SIGNAL_COMPATIBILITY (PLAYER_PROCESS + 37)

#define PLAYER_PROCESS_VIDEO_SOURCE_DOVI_PROFILE (PLAYER_PROCESS + 38)
#define PLAYER_PROCESS_VIDEO_SOURCE_DOVI_EL_PRESENT (PLAYER_PROCESS + 39)
#define PLAYER_PROCESS_VIDEO_SOURCE_DOVI_EL_TYPE (PLAYER_PROCESS + 40)
#define PLAYER_PROCESS_VIDEO_SOURCE_DOVI_BL_SIGNAL_COMPATIBILITY (PLAYER_PROCESS + 41)

#define PLAYER_PROCESS_VIDEO_DOVI_CODEC_FOURCC (PLAYER_PROCESS + 42)
#define PLAYER_PROCESS_VIDEO_DOVI_CODEC_STRING (PLAYER_PROCESS + 43)

#define PLAYER_PROCESS_VIDEO_DOVI_EL_TYPE (PLAYER_PROCESS + 44)
#define PLAYER_PROCESS_VIDEO_DOVI_META_VERSION (PLAYER_PROCESS + 45)

#define PLAYER_PROCESS_VIDEO_DOVI_L1_MIN_PQ (PLAYER_PROCESS + 46)
#define PLAYER_PROCESS_VIDEO_DOVI_L1_MAX_PQ (PLAYER_PROCESS + 47)
#define PLAYER_PROCESS_VIDEO_DOVI_L1_AVG_PQ (PLAYER_PROCESS + 48)

#define PLAYER_PROCESS_VIDEO_DOVI_L1_MIN_NITS (PLAYER_PROCESS + 49)
#define PLAYER_PROCESS_VIDEO_DOVI_L1_MAX_NITS (PLAYER_PROCESS + 50)
#define PLAYER_PROCESS_VIDEO_DOVI_L1_AVG_NITS (PLAYER_PROCESS + 51)

#define PLAYER_PROCESS_VIDEO_DOVI_SOURCE_MIN_PQ (PLAYER_PROCESS + 52)
#define PLAYER_PROCESS_VIDEO_DOVI_SOURCE_MAX_PQ (PLAYER_PROCESS + 53)
#define PLAYER_PROCESS_VIDEO_DOVI_SOURCE_MIN_NITS (PLAYER_PROCESS + 54)
#define PLAYER_PROCESS_VIDEO_DOVI_SOURCE_MAX_NITS (PLAYER_PROCESS + 55)

#define PLAYER_PROCESS_VIDEO_DOVI_L6_MAX_CLL (PLAYER_PROCESS + 56)
#define PLAYER_PROCESS_VIDEO_DOVI_L6_MAX_FALL (PLAYER_PROCESS + 57)
#define PLAYER_PROCESS_VIDEO_DOVI_L6_MIN_LUM (PLAYER_PROCESS + 58)
#define PLAYER_PROCESS_VIDEO_DOVI_L6_MAX_LUM (PLAYER_PROCESS + 59)

#define PLAYER_PROCESS_VIDEO_HDR_MAX_CLL (PLAYER_PROCESS + 70)
#define PLAYER_PROCESS_VIDEO_HDR_MAX_FALL (PLAYER_PROCESS + 71)
#define PLAYER_PROCESS_VIDEO_HDR_MIN_LUM (PLAYER_PROCESS + 72)
#define PLAYER_PROCESS_VIDEO_HDR_MAX_LUM (PLAYER_PROCESS + 73)
