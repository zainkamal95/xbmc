...
#define PLAYER_PROCESS_VIDEO_DOVI_CODEC_FOURCC (PLAYER_PROCESS + 38)
#define PLAYER_PROCESS_VIDEO_DOVI_CODEC_STRING (PLAYER_PROCESS + 39)

#define PLAYER_PROCESS_VIDEO_DOVI_EL_TYPE (PLAYER_PROCESS + 40)
#define PLAYER_PROCESS_VIDEO_DOVI_META_VERSION (PLAYER_PROCESS + 41)

#define PLAYER_PROCESS_VIDEO_DOVI_L1_MIN_PQ (PLAYER_PROCESS + 42)
#define PLAYER_PROCESS_VIDEO_DOVI_L1_MAX_PQ (PLAYER_PROCESS + 43)
#define PLAYER_PROCESS_VIDEO_DOVI_L1_AVG_PQ (PLAYER_PROCESS + 44)

#define PLAYER_PROCESS_VIDEO_DOVI_L1_MIN_NITS (PLAYER_PROCESS + 45)
#define PLAYER_PROCESS_VIDEO_DOVI_L1_MAX_NITS (PLAYER_PROCESS + 46)
#define PLAYER_PROCESS_VIDEO_DOVI_L1_AVG_NITS (PLAYER_PROCESS + 47)

#define PLAYER_PROCESS_VIDEO_DOVI_L6_MAX_CLL (PLAYER_PROCESS + 48)
#define PLAYER_PROCESS_VIDEO_DOVI_L6_MAX_FALL (PLAYER_PROCESS + 49)
#define PLAYER_PROCESS_VIDEO_DOVI_L6_MIN_LUM (PLAYER_PROCESS + 50)
#define PLAYER_PROCESS_VIDEO_DOVI_L6_MAX_LUM (PLAYER_PROCESS + 51)
