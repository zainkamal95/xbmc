...
#define PLAYER_PROCESS_VIDEO_BIT_DEPTH (PLAYER_PROCESS + 13)
#define PLAYER_PROCESS_VIDEO_HDR_TYPE (PLAYER_PROCESS + 14)
#define PLAYER_PROCESS_VIDEO_SOURCE_HDR_TYPE (PLAYER_PROCESS + 15)
#define PLAYER_PROCESS_VIDEO_WIDTH_RAW (PLAYER_PROCESS + 16)
#define PLAYER_PROCESS_VIDEO_HEIGHT_RAW (PLAYER_PROCESS + 17)
#define PLAYER_PROCESS_VIDEO_COLOR_SPACE (PLAYER_PROCESS + 18)
#define PLAYER_PROCESS_VIDEO_COLOR_RANGE (PLAYER_PROCESS + 19)
#define PLAYER_PROCESS_VIDEO_COLOR_PRIMARIES (PLAYER_PROCESS + 20)
#define PLAYER_PROCESS_VIDEO_COLOR_TRANSFER_CHARACTERISTIC (PLAYER_PROCESS + 21)
#define PLAYER_PROCESS_VIDEO_DOVI_VERSION_MAJOR (PLAYER_PROCESS + 22)
#define PLAYER_PROCESS_VIDEO_DOVI_VERSION_MINOR (PLAYER_PROCESS + 23)
#define PLAYER_PROCESS_VIDEO_DOVI_PROFILE (PLAYER_PROCESS + 24)
#define PLAYER_PROCESS_VIDEO_DOVI_LEVEL (PLAYER_PROCESS + 25)
#define PLAYER_PROCESS_VIDEO_DOVI_RPU_PRESENT (PLAYER_PROCESS + 26)
#define PLAYER_PROCESS_VIDEO_DOVI_EL_PRESENT (PLAYER_PROCESS + 27)
#define PLAYER_PROCESS_VIDEO_DOVI_BL_PRESENT (PLAYER_PROCESS + 28)
#define PLAYER_PROCESS_VIDEO_DOVI_BL_SIGNAL_COMPATIBILITY (PLAYER_PROCESS + 29)
#define PLAYER_PROCESS_VIDEO_DOVI_EL_TYPE (PLAYER_PROCESS + 30)
#define PLAYER_PROCESS_VIDEO_DOVI_CODEC_FOURCC (PLAYER_PROCESS + 31)
#define PLAYER_PROCESS_VIDEO_DOVI_CODEC_STRING (PLAYER_PROCESS + 32)
#define PLAYER_PROCESS_AML_PIXELFORMAT (PLAYER_PROCESS + 33)
#define PLAYER_PROCESS_AML_DISPLAYMODE (PLAYER_PROCESS + 34)
#define PLAYER_PROCESS_AML_EOFT_GAMUT (PLAYER_PROCESS + 35)
#define PLAYER_PROCESS_AML_VS10_MODE (PLAYER_PROCESS + 36)
#define PLAYER_PROCESS_AML_VS10_MODE_RAW (PLAYER_PROCESS + 37)
#define PLAYER_PROCESS_AML_VIDEO_FPS_INFO (PLAYER_PROCESS + 38)
#define PLAYER_PROCESS_AML_VIDEO_FPS_DROP (PLAYER_PROCESS + 39)
