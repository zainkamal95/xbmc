...
#define PLAYER_PROCESS_VIDEO_DOVI_CODEC_FOURCC (PLAYER_PROCESS + 39)
#define PLAYER_PROCESS_VIDEO_DOVI_CODEC_STRING (PLAYER_PROCESS + 40)
#define PLAYER_PROCESS_VIDEO_LIVE_BIT_RATE (PLAYER_PROCESS + 41)
#define PLAYER_PROCESS_VIDEO_LIVE_KIBIT_RATE (PLAYER_PROCESS + 42)
#define PLAYER_PROCESS_VIDEO_LIVE_MIBIT_RATE (PLAYER_PROCESS + 43)
#define PLAYER_PROCESS_VIDEO_QUEUE_LEVEL (PLAYER_PROCESS + 44)
#define PLAYER_PROCESS_VIDEO_QUEUE_DATA_LEVEL (PLAYER_PROCESS + 45)
