...
#define PLAYER_PROCESS_VIDEO_DOVI_EL_TYPE (PLAYER_PROCESS + 38)
#define PLAYER_PROCESS_VIDEO_DOVI_META_VERSION (PLAYER_PROCESS + 39)
#define PLAYER_PROCESS_VIDEO_DOVI_CODEC_FOURCC (PLAYER_PROCESS + 40)
#define PLAYER_PROCESS_VIDEO_DOVI_CODEC_STRING (PLAYER_PROCESS + 41)
#define PLAYER_PROCESS_VIDEO_LIVE_BIT_RATE (PLAYER_PROCESS + 42)
#define PLAYER_PROCESS_VIDEO_LIVE_KIBIT_RATE (PLAYER_PROCESS + 43)
#define PLAYER_PROCESS_VIDEO_LIVE_MIBIT_RATE (PLAYER_PROCESS + 44)
#define PLAYER_PROCESS_VIDEO_QUEUE_LEVEL (PLAYER_PROCESS + 45)
#define PLAYER_PROCESS_VIDEO_QUEUE_DATA_LEVEL (PLAYER_PROCESS + 46)

#define PLAYER_PROCESS_AML_PIXELFORMAT (PLAYER_PROCESS + 50)
#define PLAYER_PROCESS_AML_DISPLAYMODE (PLAYER_PROCESS + 51)
#define PLAYER_PROCESS_AML_EOFT_GAMUT (PLAYER_PROCESS + 52)
#define PLAYER_PROCESS_AML_VS10_MODE (PLAYER_PROCESS + 53)
#define PLAYER_PROCESS_AML_VS10_MODE_RAW (PLAYER_PROCESS + 54)
#define PLAYER_PROCESS_AML_VIDEO_FPS_INFO (PLAYER_PROCESS + 55)
#define PLAYER_PROCESS_AML_VIDEO_FPS_DROP (PLAYER_PROCESS + 56)
