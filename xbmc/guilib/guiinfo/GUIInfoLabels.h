...
#define PLAYER_PROCESS_VIDEO_BIT_DEPTH (PLAYER_PROCESS + 33)
#define PLAYER_PROCESS_VIDEO_HDR_TYPE (PLAYER_PROCESS + 34)
#define PLAYER_PROCESS_VIDEO_SOURCE_HDR_TYPE (PLAYER_PROCESS + 35)
#define PLAYER_PROCESS_VIDEO_COLOR_SPACE (PLAYER_PROCESS + 36)
#define PLAYER_PROCESS_VIDEO_COLOR_RANGE (PLAYER_PROCESS + 37)
#define PLAYER_PROCESS_VIDEO_COLOR_PRIMARIES (PLAYER_PROCESS + 38)
#define PLAYER_PROCESS_VIDEO_COLOR_TRANSFER_CHARACTERISTIC (PLAYER_PROCESS + 39)
#define PLAYER_PROCESS_VIDEO_DOVI_VERSION_MAJOR (PLAYER_PROCESS + 40)
#define PLAYER_PROCESS_VIDEO_DOVI_VERSION_MINOR (PLAYER_PROCESS + 41)
#define PLAYER_PROCESS_VIDEO_DOVI_PROFILE (PLAYER_PROCESS + 42)
#define PLAYER_PROCESS_VIDEO_DOVI_LEVEL (PLAYER_PROCESS + 43)
#define PLAYER_PROCESS_VIDEO_DOVI_RPU_PRESENT (PLAYER_PROCESS + 44)
#define PLAYER_PROCESS_VIDEO_DOVI_EL_PRESENT (PLAYER_PROCESS + 45)
#define PLAYER_PROCESS_VIDEO_DOVI_BL_PRESENT (PLAYER_PROCESS + 46)
#define PLAYER_PROCESS_VIDEO_DOVI_BL_SIGNAL_COMPATIBILITY (PLAYER_PROCESS + 47)
#define PLAYER_PROCESS_VIDEO_DOVI_EL_TYPE (PLAYER_PROCESS + 48)
#define PLAYER_PROCESS_VIDEO_DOVI_CODEC_FOURCC (PLAYER_PROCESS + 49)
#define PLAYER_PROCESS_VIDEO_DOVI_CODEC_STRING (PLAYER_PROCESS + 50)
#define PLAYER_PROCESS_AML_VS10_MODE (PLAYER_PROCESS + 51)
#define PLAYER_PROCESS_AML_VS10_MODE_RAW (PLAYER_PROCESS + 52)
#define PLAYER_PROCESS_AML_VIDEO_FPS_INFO (PLAYER_PROCESS + 53)
