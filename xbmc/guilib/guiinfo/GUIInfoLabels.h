...
#define PLAYER_PROCESS_VIDEO_SOURCE_ADDITIONAL_HDR_TYPE (PLAYER_PROCESS + 24)
#define PLAYER_PROCESS_VIDEO_WIDTH_RAW (PLAYER_PROCESS + 25)
#define PLAYER_PROCESS_VIDEO_HEIGHT_RAW (PLAYER_PROCESS + 26)
#define PLAYER_PROCESS_VIDEO_COLOR_SPACE (PLAYER_PROCESS + 27)
#define PLAYER_PROCESS_VIDEO_COLOR_RANGE (PLAYER_PROCESS + 28)
#define PLAYER_PROCESS_VIDEO_COLOR_PRIMARIES (PLAYER_PROCESS + 29)
#define PLAYER_PROCESS_VIDEO_COLOR_TRANSFER_CHARACTERISTIC (PLAYER_PROCESS + 30)
...
#define PLAYER_PROCESS_VIDEO_DOVI_SOURCE_MIN_PQ (PLAYER_PROCESS + 76)
#define PLAYER_PROCESS_VIDEO_DOVI_SOURCE_MAX_PQ (PLAYER_PROCESS + 77)
#define PLAYER_PROCESS_VIDEO_DOVI_SOURCE_MIN_NITS (PLAYER_PROCESS + 78)
#define PLAYER_PROCESS_VIDEO_DOVI_SOURCE_MAX_NITS (PLAYER_PROCESS + 79)

#define PLAYER_PROCESS_VIDEO_DOVI_HAS_L6 (PLAYER_PROCESS + 80)
#define PLAYER_PROCESS_VIDEO_DOVI_L6_MAX_CLL (PLAYER_PROCESS + 81)
#define PLAYER_PROCESS_VIDEO_DOVI_L6_MAX_FALL (PLAYER_PROCESS + 82)
#define PLAYER_PROCESS_VIDEO_DOVI_L6_MIN_LUM (PLAYER_PROCESS + 83)
#define PLAYER_PROCESS_VIDEO_DOVI_L6_MAX_LUM (PLAYER_PROCESS + 84)

#define PLAYER_PROCESS_VIDEO_HDR_HAS_CLL (PLAYER_PROCESS + 90)
#define PLAYER_PROCESS_VIDEO_HDR_MAX_CLL (PLAYER_PROCESS + 91)
#define PLAYER_PROCESS_VIDEO_HDR_MAX_FALL (PLAYER_PROCESS + 92)
#define PLAYER_PROCESS_VIDEO_HDR_HAS_MDCV (PLAYER_PROCESS + 93)
#define PLAYER_PROCESS_VIDEO_HDR_MIN_LUM (PLAYER_PROCESS + 94)
#define PLAYER_PROCESS_VIDEO_HDR_MAX_LUM (PLAYER_PROCESS + 95)
#define PLAYER_PROCESS_VIDEO_HDR_COLOUR_PRIMARIES (PLAYER_PROCESS + 96)

#define PLAYER_PROCESS_VIDEO_LIVE_BIT_RATE (PLAYER_PROCESS + 100)
#define PLAYER_PROCESS_VIDEO_LIVE_KIBIT_RATE (PLAYER_PROCESS + 101)
#define PLAYER_PROCESS_VIDEO_LIVE_MIBIT_RATE (PLAYER_PROCESS + 102)
#define PLAYER_PROCESS_VIDEO_QUEUE_LEVEL (PLAYER_PROCESS + 103)
#define PLAYER_PROCESS_VIDEO_QUEUE_DATA_LEVEL (PLAYER_PROCESS + 104)

#define PLAYER_PROCESS_VIDEO_PTS (PLAYER_PROCESS + 105)

#define PLAYER_PROCESS_AML_PIXELFORMAT (PLAYER_PROCESS + 110)
#define PLAYER_PROCESS_AML_DISPLAYMODE (PLAYER_PROCESS + 111)
#define PLAYER_PROCESS_AML_EOFT_GAMUT (PLAYER_PROCESS + 112)
#define PLAYER_PROCESS_AML_VS10_MODE (PLAYER_PROCESS + 113)
#define PLAYER_PROCESS_AML_VS10_MODE_RAW (PLAYER_PROCESS + 114)
#define PLAYER_PROCESS_AML_VIDEO_FPS_INFO (PLAYER_PROCESS + 115)
#define PLAYER_PROCESS_AML_VIDEO_FPS_DROP (PLAYER_PROCESS + 116)
