...
#define VIDEOPLAYER_SUBTITLES_LANG_EX 289
#define VIDEOPLAYER_SUBTITLES_NAME    290
#define VIDEOPLAYER_AUDIO_LANG        291
#define VIDEOPLAYER_AUDIO_LANG_EX     292 
#define VIDEOPLAYER_AUDIO_NAME        293
#define VIDEOPLAYER_STEREOSCOPIC_MODE 294
#define VIDEOPLAYER_CAST              295
#define VIDEOPLAYER_CAST_AND_ROLE     296
#define VIDEOPLAYER_UNIQUEID          297
#define VIDEOPLAYER_AUDIOSTREAMCOUNT  298
#define VIDEOPLAYER_VIDEOVERSION_NAME 299
...
#define PLAYER_PROCESS_AUDIO_IS_DOLBY_ATMOS (PLAYER_PROCESS + 13)
#define PLAYER_PROCESS_AUDIO_DTS_X_TYPE (PLAYER_PROCESS + 14)
...
#define PLAYER_PROCESS_VIDEO_SOURCE_HDR_TYPE (PLAYER_PROCESS + 23)
#define PLAYER_PROCESS_VIDEO_WIDTH_RAW (PLAYER_PROCESS + 24)
#define PLAYER_PROCESS_VIDEO_HEIGHT_RAW (PLAYER_PROCESS + 25)
#define PLAYER_PROCESS_VIDEO_COLOR_SPACE (PLAYER_PROCESS + 26)
#define PLAYER_PROCESS_VIDEO_COLOR_RANGE (PLAYER_PROCESS + 27)
#define PLAYER_PROCESS_VIDEO_COLOR_PRIMARIES (PLAYER_PROCESS + 28)
#define PLAYER_PROCESS_VIDEO_COLOR_TRANSFER_CHARACTERISTIC (PLAYER_PROCESS + 29)

#define PLAYER_PROCESS_VIDEO_DOVI_HAS_CONFIG (PLAYER_PROCESS + 30)

#define PLAYER_PROCESS_VIDEO_DOVI_VERSION_MAJOR (PLAYER_PROCESS + 31)
#define PLAYER_PROCESS_VIDEO_DOVI_VERSION_MINOR (PLAYER_PROCESS + 32)
#define PLAYER_PROCESS_VIDEO_DOVI_PROFILE (PLAYER_PROCESS + 33)
#define PLAYER_PROCESS_VIDEO_DOVI_LEVEL (PLAYER_PROCESS + 34)
#define PLAYER_PROCESS_VIDEO_DOVI_RPU_PRESENT (PLAYER_PROCESS + 35)
#define PLAYER_PROCESS_VIDEO_DOVI_EL_PRESENT (PLAYER_PROCESS + 36)
#define PLAYER_PROCESS_VIDEO_DOVI_BL_PRESENT (PLAYER_PROCESS + 37)
#define PLAYER_PROCESS_VIDEO_DOVI_BL_SIGNAL_COMPATIBILITY (PLAYER_PROCESS + 38)

#define PLAYER_PROCESS_VIDEO_SOURCE_DOVI_PROFILE (PLAYER_PROCESS + 39)
#define PLAYER_PROCESS_VIDEO_SOURCE_DOVI_EL_PRESENT (PLAYER_PROCESS + 40)
#define PLAYER_PROCESS_VIDEO_SOURCE_DOVI_EL_TYPE (PLAYER_PROCESS + 41)
#define PLAYER_PROCESS_VIDEO_SOURCE_DOVI_BL_SIGNAL_COMPATIBILITY (PLAYER_PROCESS + 42)

#define PLAYER_PROCESS_VIDEO_DOVI_CODEC_FOURCC (PLAYER_PROCESS + 43)
#define PLAYER_PROCESS_VIDEO_DOVI_CODEC_STRING (PLAYER_PROCESS + 44)

#define PLAYER_PROCESS_VIDEO_DOVI_EL_TYPE (PLAYER_PROCESS + 45)
#define PLAYER_PROCESS_VIDEO_DOVI_META_VERSION (PLAYER_PROCESS + 46)

#define PLAYER_PROCESS_VIDEO_DOVI_HAS_HEADER (PLAYER_PROCESS + 47)

#define PLAYER_PROCESS_VIDEO_DOVI_L1_MIN_PQ (PLAYER_PROCESS + 48)
#define PLAYER_PROCESS_VIDEO_DOVI_L1_MAX_PQ (PLAYER_PROCESS + 49)
#define PLAYER_PROCESS_VIDEO_DOVI_L1_AVG_PQ (PLAYER_PROCESS + 50)

#define PLAYER_PROCESS_VIDEO_DOVI_L1_MIN_NITS (PLAYER_PROCESS + 51)
#define PLAYER_PROCESS_VIDEO_DOVI_L1_MAX_NITS (PLAYER_PROCESS + 52)
#define PLAYER_PROCESS_VIDEO_DOVI_L1_AVG_NITS (PLAYER_PROCESS + 53)

#define PLAYER_PROCESS_VIDEO_DOVI_SOURCE_MIN_PQ (PLAYER_PROCESS + 54)
#define PLAYER_PROCESS_VIDEO_DOVI_SOURCE_MAX_PQ (PLAYER_PROCESS + 55)
#define PLAYER_PROCESS_VIDEO_DOVI_SOURCE_MIN_NITS (PLAYER_PROCESS + 56)
#define PLAYER_PROCESS_VIDEO_DOVI_SOURCE_MAX_NITS (PLAYER_PROCESS + 57)

#define PLAYER_PROCESS_VIDEO_DOVI_HAS_L6 (PLAYER_PROCESS + 58)
#define PLAYER_PROCESS_VIDEO_DOVI_L6_MAX_CLL (PLAYER_PROCESS + 59)
#define PLAYER_PROCESS_VIDEO_DOVI_L6_MAX_FALL (PLAYER_PROCESS + 60)
#define PLAYER_PROCESS_VIDEO_DOVI_L6_MIN_LUM (PLAYER_PROCESS + 61)
#define PLAYER_PROCESS_VIDEO_DOVI_L6_MAX_LUM (PLAYER_PROCESS + 62)

#define PLAYER_PROCESS_VIDEO_HDR_HAS_CLL (PLAYER_PROCESS + 70)
#define PLAYER_PROCESS_VIDEO_HDR_MAX_CLL (PLAYER_PROCESS + 71)
#define PLAYER_PROCESS_VIDEO_HDR_MAX_FALL (PLAYER_PROCESS + 72)
#define PLAYER_PROCESS_VIDEO_HDR_HAS_MDCV (PLAYER_PROCESS + 73)
#define PLAYER_PROCESS_VIDEO_HDR_MIN_LUM (PLAYER_PROCESS + 74)
#define PLAYER_PROCESS_VIDEO_HDR_MAX_LUM (PLAYER_PROCESS + 75)
#define PLAYER_PROCESS_VIDEO_HDR_COLOUR_PRIMARIES (PLAYER_PROCESS + 76)

#define PLAYER_PROCESS_VIDEO_LIVE_BIT_RATE (PLAYER_PROCESS + 80)
#define PLAYER_PROCESS_VIDEO_LIVE_KIBIT_RATE (PLAYER_PROCESS + 81)
#define PLAYER_PROCESS_VIDEO_LIVE_MIBIT_RATE (PLAYER_PROCESS + 82)
#define PLAYER_PROCESS_VIDEO_QUEUE_LEVEL (PLAYER_PROCESS + 83)
#define PLAYER_PROCESS_VIDEO_QUEUE_DATA_LEVEL (PLAYER_PROCESS + 84)

#define PLAYER_PROCESS_VIDEO_PTS (PLAYER_PROCESS + 85)

#define PLAYER_PROCESS_AML_PIXELFORMAT (PLAYER_PROCESS + 90)
#define PLAYER_PROCESS_AML_DISPLAYMODE (PLAYER_PROCESS + 91)
#define PLAYER_PROCESS_AML_EOFT_GAMUT (PLAYER_PROCESS + 92)
#define PLAYER_PROCESS_AML_VS10_MODE (PLAYER_PROCESS + 93)
#define PLAYER_PROCESS_AML_VS10_MODE_RAW (PLAYER_PROCESS + 94)
#define PLAYER_PROCESS_AML_VIDEO_FPS_INFO (PLAYER_PROCESS + 95)
#define PLAYER_PROCESS_AML_VIDEO_FPS_DROP (PLAYER_PROCESS + 96)
