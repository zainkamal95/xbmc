...
#define PLAYER_PROCESS_AV_CHANGE (PLAYER_PROCESS + 120)

#define PLAYER_PROCESS_AUDIO_PTS (PLAYER_PROCESS + 130)
#define PLAYER_PROCESS_VIDEO_PTS (PLAYER_PROCESS + 131)
#define PLAYER_PROCESS_DIFF_PTS (PLAYER_PROCESS + 132)
