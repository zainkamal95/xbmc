...
#define PLAYER_PROCESS_VIDEO_DOVI_L6_MAX_CLL (PLAYER_PROCESS + 52)
#define PLAYER_PROCESS_VIDEO_DOVI_L6_MAX_FALL (PLAYER_PROCESS + 53)
#define PLAYER_PROCESS_VIDEO_DOVI_L6_MIN_LUM (PLAYER_PROCESS + 54)
#define PLAYER_PROCESS_VIDEO_DOVI_L6_MAX_LUM (PLAYER_PROCESS + 55)

#define PLAYER_PROCESS_VIDEO_HDR_MAX_CLL (PLAYER_PROCESS + 60)
#define PLAYER_PROCESS_VIDEO_HDR_MAX_FALL (PLAYER_PROCESS + 61)
#define PLAYER_PROCESS_VIDEO_HDR_MIN_LUM (PLAYER_PROCESS + 62)
#define PLAYER_PROCESS_VIDEO_HDR_MAX_LUM (PLAYER_PROCESS + 63)

#define PLAYER_PROCESS_VIDEO_LIVE_BIT_RATE (PLAYER_PROCESS + 70)
#define PLAYER_PROCESS_VIDEO_LIVE_KIBIT_RATE (PLAYER_PROCESS + 71)
#define PLAYER_PROCESS_VIDEO_LIVE_MIBIT_RATE (PLAYER_PROCESS + 72)
#define PLAYER_PROCESS_VIDEO_QUEUE_LEVEL (PLAYER_PROCESS + 73)
#define PLAYER_PROCESS_VIDEO_QUEUE_DATA_LEVEL (PLAYER_PROCESS + 74)

#define PLAYER_PROCESS_AML_PIXELFORMAT (PLAYER_PROCESS + 80)
#define PLAYER_PROCESS_AML_DISPLAYMODE (PLAYER_PROCESS + 81)
#define PLAYER_PROCESS_AML_EOFT_GAMUT (PLAYER_PROCESS + 82)
#define PLAYER_PROCESS_AML_VS10_MODE (PLAYER_PROCESS + 83)
#define PLAYER_PROCESS_AML_VS10_MODE_RAW (PLAYER_PROCESS + 84)
#define PLAYER_PROCESS_AML_VIDEO_FPS_INFO (PLAYER_PROCESS + 85)
#define PLAYER_PROCESS_AML_VIDEO_FPS_DROP (PLAYER_PROCESS + 86)
