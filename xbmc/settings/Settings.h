...
public:
  ...
  static constexpr auto SETTING_COREELEC_AMLOGIC_DV_VSVDB = "coreelec.amlogic.dolbyvision.vsvdb";
  static constexpr auto SETTING_COREELEC_AMLOGIC_DV_VS10_SDR = "coreelec.amlogic.dolbyvision.vs10.sdr";
